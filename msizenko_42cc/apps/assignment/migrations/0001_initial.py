...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('assignment_userprofile', (
        ...
        db.send_create_signal('assignment', ['UserProfile'])

        # Adding model 'Contact'
        db.create_table('assignment_contact', (
        ...
        db.send_create_signal('assignment', ['Contact'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('assignment_userprofile')

        # Deleting model 'Contact'
        db.delete_table('assignment_contact')
